defmodule SymphonyElixir.CoreTest do
  ...
  defp assert_due_in_range(due_at_ms, before_down_ms, after_state_ms, min_delay_ms, max_delay_ms) do
    assert due_at_ms >= before_down_ms + min_delay_ms
    assert due_at_ms <= after_state_ms + max_delay_ms
  end
