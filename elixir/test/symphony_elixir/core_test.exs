defmodule SymphonyElixir.CoreTest do
  ...
  test "current WORKFLOW.md file is valid and complete" do
    ...
    assert Map.get(hooks, "after_create") =~ "https://github.com/"
  ...
  test "abnormal worker exit increments retry attempt progressively" do
    ...
    assert_due_after_in_range(due_at_ms, scheduled_after_ms, 39_500, 40_500)
  end
  ...
  test "first abnormal worker exit waits before retrying" do
    ...
    assert_due_after_in_range(due_at_ms, scheduled_after_ms, 9_000, 10_500)
  end
  ...
  defp assert_due_after_in_range(due_at_ms, scheduled_after_ms, min_delay_ms, max_delay_ms) do
