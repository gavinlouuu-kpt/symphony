defmodule SymphonyElixir.StatusDashboard do
    ...
    project_part =
      case tracker.project_slug do
        project_slug when is_binary(project_slug) and project_slug != "" ->
          colorize(tracker_project_url(tracker.kind, project_slug), @ansi_cyan)
  ...
  defp tracker_project_url("github", repository), do: "https://github.com/#{repository}/issues"
  defp tracker_project_url(_kind, project_slug), do: "https://linear.app/project/#{project_slug}/issues"
